...
*** Acquiring & Saving Images & Data Menu
 ...
 - file:PhilaJ-button-files.gif  ::
   ...
   - [[#make-roianno-preview][=Create ROI Annotated Preview Image=]]
...
The [[#make-roianno-preview][=Create ROI Annotated Preview Image=]] menu item will create an image with each ROI drawn -- right now plate flaw and fault
