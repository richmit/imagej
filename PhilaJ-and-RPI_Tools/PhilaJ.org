...
*** Everything Else Menu
 ...
 - file:PhilaJ-button-misc.gif  ::
   ...
   - ---
   - [[#sheet-tools][=Separate stamp multiple=]]
   - ---
...
I expect to add more functionality in this category over time.  Right now we have one tool, the [[#sheet-tools][=Separate stamp multiple=]] menu option.  This
tool is designed to break up images of stamp blocks into stacks of individual images.  When activated the following dialog will appear:
...
are used to label the stamp images with the position number from the original sheet from which the block came:
 ...
 - The width of the *sheet* from which the block came -- if you don't know, then set it to the number of columns in the block
