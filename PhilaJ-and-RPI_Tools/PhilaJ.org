...
Installing PhilaJ requires the "=PhilaJ.ijm=" file be copied into the Fiji the "=/macros/toolsets/=" directory inside the Fiji install.  For example, on my
Windows computer, I copy it to "=c:\Users\richmit\PF\Fiji.app\macros\toolsets\PhilaJ.ijm=".  If ImageJ was running when you copied the file, then you need to
quite and restart it.
