...
be found inside the Fiji install directory.  For example, I install Fiji at "=c:\Users\richmit\PF\Fiji.app=", and thus I copy the "=PhilaJ.ijm=" file to
...
:END:
 ...
 - BARI Wolf Issue Perforation Gauge :: This gauge is based on measurements of my personal collection -- I have well over 50 copies of this stamp.
 ...
 - AMG AM Post :: I'm starting a project to put together a set of gauges for AMG issues.  Right now I have the templates installed, but the gap values are stock
   catalog values.  I hope to update these with measured values from my collection.
